...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "nUpzQYAB#FG8McrfWeHFk2C0vIANd6ezKjI0NQaThjWTe1XNbT6s", // Add your session id
PREFIX: process.env.PREFIX || ".",
MODE: process.env.MODE || "public",  //public | private | inbox | group
OWNER_NUMBER: process.env.OWNER_NUMBER || "94761196374",
DEV: process.env.DEV || "94761196374",
...
CUSTOM_REACT_EMOJIS: process.env.CUSTOM_REACT_EMOJIS || "💝,💖,💗,❤️‍🩹a,❤️,🧡,💛,💚,💙,💜,🤎,🖤,🤍",
